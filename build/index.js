...
var ASM_CONSTS = {
  119960: () => { if (document.fullscreenElement) return 1; },  
 120006: () => { return document.getElementById('canvas').width; },  
 120058: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120126: () => { document.exitFullscreen(); },  
 120153: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 120226: () => { if (document.fullscreenElement) return 1; },  
 120272: () => { return document.getElementById('canvas').width; },  
 120324: () => { return screen.width; },  
 120349: () => { document.exitFullscreen(); },  
 120376: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 120509: () => { return window.innerWidth; },  
 120535: () => { return window.innerHeight; },  
 120562: () => { if (document.fullscreenElement) return 1; },  
 120608: () => { return document.getElementById('canvas').width; },  
 120660: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120728: () => { if (document.fullscreenElement) return 1; },  
 120774: () => { return document.getElementById('canvas').width; },  
 120826: () => { return screen.width; },  
 120851: () => { return window.innerWidth; },  
 120877: () => { return window.innerHeight; },  
 120904: () => { if (document.fullscreenElement) return 1; },  
 120950: () => { return document.getElementById('canvas').width; },  
 121002: () => { return screen.width; },  
 121027: () => { document.exitFullscreen(); },  
 121054: () => { if (document.fullscreenElement) return 1; },  
 121100: () => { return document.getElementById('canvas').width; },  
 121152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121220: () => { document.exitFullscreen(); },  
 121247: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 121305: () => { return screen.width; },  
 121330: () => { return screen.height; },  
 121356: () => { return window.screenX; },  
 121383: () => { return window.screenY; },  
 121410: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 121463: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 121534: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 121591: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 121847: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 121918: () => { if (document.fullscreenElement) return 1; },  
 121964: () => { return window.innerWidth; },  
 121990: () => { return window.innerHeight; },  
 122017: () => { if (document.pointerLockElement) return 1; }
};
